        ...
        <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbars-host">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item active"><a class="nav-link" href="index.html">Home</a></li>
                    <li className="nav-item"><a class="nav-link" href="about.html">About Us</a></li>
                    ...
                    <li className="nav-item"><a class="nav-link" href="gallery.html">Gallery</a></li>
                    <li className="nav-item"><a class="nav-link" href="service.html">Services</a></li>

                    <li className="nav-item"><a class="nav-link" href="pricing.html">Pricing</a></li>
...
<section className="forms-section">
    <h1 className="section-title">Learn to Thrive</h1>
    <div className="forms">
